 ...
 */
class PostulacionSearchEvaluacion3 extends Postulacion
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['concursante','convocatoria','estadopostulacion','evaluacion','rutConcursante', 'nombreOrganizacion', 'nombreProyecto','estadoEvaluacion', 'total', 'aporteSolicitado'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        'desc' => ['formulario.nombre_proyecto' => SORT_DESC],
           ...
           $dataProvider->sort->attributes['aporteSolicitado'] = [
     ...
     $dataProvider->sort->attributes['total'] = [
        ...
        ])->andFilterWhere(['like', 'convocatoria.nombreConvocatoria', $this->convocatoria])->andFilterWhere(['like','convocatoria.id_estadoConvocatoria', 2])->andFilterWhere(['like', 'evaluacion.etapa', 3])->andFilterWhere(['like', 'concursante.nombreConcursante', $this->concursante])->andFilterWhere(['like', '(evaluacion.puntaje_1 + evaluacion.puntaje_2 + evaluacion.puntaje_3)', $this->total])->andFilterWhere(['like', 'concursante.rut', $this->rutConcursante])->andFilterWhere(['like', 'formulario.nombre_organizacion', $this->nombreOrganizacion])->andFilterWhere(['like', 'formulario.financiamiento_aporte_solicitado', $this->aporteSolicitado])->andFilterWhere(['like', 'formulario.nombre_proyecto', $this->nombreProyecto])->andFilterWhere(['like', 'evaluacion.id_estado', $this->estadoEvaluacion])->andFilterWhere(['like', 'estadopostulacion.nombre_estadopostulacion', $this->estadopostulacion])->andFilterWhere(['like', 'postulacion.montoAsignado', $this->montoAsignado])
