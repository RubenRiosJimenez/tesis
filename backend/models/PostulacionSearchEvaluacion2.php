 ...
 */
class PostulacionSearchEvaluacion2 extends Postulacion
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['concursante','convocatoria','estadopostulacion','evaluacion','rutConcursante', 'nombreOrganizacion', 'nombreProyecto','estadoEvaluacion', 'total'], 'safe'],
        ];
    }
